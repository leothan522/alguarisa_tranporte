...
class ParametrosController extends Admin
{
    ...
    ): void
    {
        ...
        $this->totalParametros = $model->count();
    ...
    public function store($name, $tabla_id, $valor): void
    {
        $model = new Parametro();
    ...
    public function search($keyword): void
    {
        ...
        $sql = "parametros WHERE nombre LIKE '%$keyword%'";
        $this->totalParametros = $model->sqlPersonalizado($sql, 'count');
    }
