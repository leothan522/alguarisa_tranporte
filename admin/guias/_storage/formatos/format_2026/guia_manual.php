...
$pdf->Cell(0, 5, verUtf8('A los _________________ DÍAS DEL MES DE ___________________ DEL AÑO' . date(' Y')), 0, 1, 'L');
$pdf->SetFont('times', '', 10);
$pdf->Ln(15);
