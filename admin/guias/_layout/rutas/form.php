<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select class="select2bs4 select_rutas_municipios" data-placeholder="Seleccionar" name="origen"
                    id="select_rutas_origen">
        ...
        <div class="form-group">
            ...
            <div id="items">
                <div class="row" id="item_1">
                    <div class="col-10">
                        <input type="text" class="form-control input_rutas_items" name="ruta_1" placeholder="Lugar"
                               id="ruta_1">
                    </div>
                    <div class="col-2">
                        <span class="btn">&nbsp;</span>
        ...
        <div class="form-group">
            ...
            <select class="select2bs4 select_rutas_municipios" data-placeholder="Seleccionar" name="destino"
                    id="select_rutas_destino">
                <option value="">Seleccione</option>
            </select>
