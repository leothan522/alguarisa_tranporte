        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Nombre completo"
                                   name="parroquia_nombre" id="parroquia_nombre">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <i class="fas fa-globe"></i>
                                </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Ingrese nombre corto"
                                   name="parroquia_mini" id="parroquia_mini">
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Ingrese la cantidad de familias"
                                   name="parroquia_asignacion" id="parroquia_asignacion">
                            <div class="input-group-append">
                                <div class="input-group-text">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="parroquia_btn_cancelar">
                        Cancelar
                    </button>
                </div>
                <?php verCargando(); ?>
